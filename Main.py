...
class Form2(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.label_img.setPixmap(QPixmap('images/ee.png'))
...
class Form4(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QtGui.QIcon('images/logo.png'))
        self.label_img.setPixmap(QPixmap('images/qq.png'))
        self.label_img.setScaledContents(True)
...
class Form3(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QtGui.QIcon('images/logo.png'))
        self.label_img.setPixmap(QPixmap('images/ww.png'))
